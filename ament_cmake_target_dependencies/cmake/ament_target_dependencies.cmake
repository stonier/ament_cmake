...
function(ament_target_dependencies target)
  ...
  if(${ARGC} GREATER 0)
    ...
    foreach(package_name ${ARG_UNPARSED_ARGUMENTS})
      ...
      list(APPEND interfaces ${${package_name}_INTERFACES})
    endforeach()
    ...
    ament_libraries_deduplicate(unique_interfaces ${interfaces})
    target_link_libraries(${target}
      ${TARGET_LINK_LIBRARIES_VISIBILITY} ${unique_libraries} ${unique_interfaces})
